...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"telerik/kendo.menu.min.js":[function(require,module,exports) {
var define;
...
!function (e, define) {
  ...
  return function (e, t) {
    ...
    function p(e) {
      var t, n;
      if (e && e.length) for (t in e) {
        n = e.eq(t), n.find("ul").length ? n.attr("aria-haspopup", !0) : n.removeAttr("aria-haspopup");
      }
    }
    ...
    function v(t, n) {
      ...
      return o.each(function (o, r) {
        ...
        for (r = e(r), a = r.data(we), s = t; a;) {
          s = n.find(h(a) + ":visible"), s.length && i.push(s), r = s.find(m()), a = r.data(we);
        }
      }), i;
    }
    ...
    function k(t, n) {
      var o,
          ...
          r = [],
          a = function a(e) {
        for (; e.parentNode && !n.is(e.parentNode);) {
          r.push(e.parentNode), e = e.parentNode;
        }
      },
          s = t[0] || t;

      for (a(s), o = r[r.length - 1]; e(o).is(Se) && (i = e(o).children("ul"), s = g(i, n)[0]);) {
        r.push(s), a(s), o = r[r.length - 1];
      }
    ...
    function C(e, t) {
      for (var n = 0, o = e.parentNode; o && !isNaN(o[t]);) {
        n += o[t], o = o.parentNode;
      }
    ...
    var O = window.kendo,
      ...
      content: "dataContentField"
        ...
        Ke = {
      wrapperCssClass: function wrapperCssClass(e, t) {
      ...
      itemCssAttributes: function itemCssAttributes(e) {
        var t,
            n = "",
            o = e.attr || {};

        for (t in o) {
          o.hasOwnProperty(t) && "class" !== t && (n += t + '="' + o[t] + '" ');
        }

        return n;
      },
      imageCssAttributes: function imageCssAttributes(e) {
        var t,
            n = "",
      ...
      contentCssAttributes: function contentCssAttributes(e) {
        var t,
            n = "",
            o = e.contentAttr || {},
      ...
      _attachMenuEventsHandlers: function _attachMenuEventsHandlers() {
        var t = this,
            n = t.element,
            o = t.options,
      ...
      _overflowWrapper: function _overflowWrapper() {
        return this._scrollWrapper || this._popupsWrapper;
      },
      _setOverflowWrapperWidth: function _setOverflowWrapperWidth(e, t) {
        var n,
            o,
            i,
            r,
      ...
      _reinitOverflow: function _reinitOverflow(e) {
        var t = this,
      ...
      _destroyOverflow: function _destroyOverflow() {
        var n = this,
      ...
      _initScrolling: function _initScrolling(t, n, o, i) {
        var r = this,
      ...
      _toggleScrollButtons: function _toggleScrollButtons(e, t, n, o) {
      ...
      attemptGetItem: function attemptGetItem(t) {
        var n, o;
      ...
      _insert: function _insert(t, n, o) {
        var i,
            a,
            s,
            l,
      ...
      _openAfterLoad: function _openAfterLoad(e, t) {
        var n = this;
        ...
        return i = (f || l.element).find(i), r = l.dataSource && l.dataSource.getByUid(i.data(O.ns + "uid")), r && r.hasChildren && !r.loaded() && !l._loading ? (l._loading = !0, i.find(Y).addClass("k-i-loading"), r.load(), l._openAfterLoad(i, r), t) : (/^(top|bottom|default)$/.test(u) && (u = d ? c ? (u + " left").replace("default", "bottom") : "left" : c ? (u + " right").replace("default", "bottom") : "right"), a = ">.k-popup:visible,>.k-animation-container>.k-popup:visible", s = function s() {
          ...
          clearTimeout(i.data(Z)), i.data(Z, setTimeout(function () {
            var r,
                ...
                w,
                C,
                b = i.find(".k-menu-group:first:hidden");

            !b[0] && f && (a = l._getPopup(i), b = a && a.element), b.is(":visible") || b[0] && l._triggerEvent({
              item: i[0],
              type: j
            }) === !1 && (!b.find(".k-menu-group")[0] && b.children(".k-item").length > 1 ? (s = e(window).height(), h = function h() {
              b.css({
      ...
      _configurePopupOverflow: function _configurePopupOverflow(e, t) {
        var n,
            o = this;
      ...
      _wrapPopupElement: function _wrapPopupElement(e) {
      ...
      _initPopupScrolling: function _initPopupScrolling(e, t, n) {
        var o = this;
        o.options.scrollable && e.element[0].scrollHeight > e.element[0].offsetHeight && o._initPopupScrollButtons(e, t, n);
      },
      _initPopupScrollButtons: function _initPopupScrollButtons(t, n, o) {
        var i = this,
      ...
      close: function close(t, n) {
        ...
        return t = s.find(t), t.length || (t = s.find(">.k-item")), o = function o(t) {
          var n = !1;
      ...
      _getPopup: function _getPopup(e) {
        var t,
            n,
            o = this,
      ...
      _checkActiveElement: function _checkActiveElement(t) {
        var n = this,
      ...
      _removeHoverItem: function _removeHoverItem() {
      ...
      _mouseenter: function _mouseenter(t) {
        var n = this,
            o = e(t.currentTarget),
      ...
      _mouseleave: function _mouseleave(n) {
        var o = this,
            r = e(n.currentTarget),
            a = r.data(we),
      ...
      _mouseenterPopup: function _mouseenterPopup(t) {
        var n,
            o = this,
            i = e(t.currentTarget);
        i.parent().is(Se) || (i = i.children("ul"), n = i.data(ke), n && (o._openedPopups["" + n] = !0));
      },
      _mouseleavePopup: function _mouseleavePopup(t) {
        var n = this,
            o = e(t.currentTarget);
        !b(t) && o.is(Se) && n._closePopups(o.children("ul"));
      },
      _closePopups: function _closePopups(t) {
        var n,
            o = this,
        ...
        r && (delete o._openedPopups["" + r], n = i.find(m(r)), setTimeout(function () {
          if (o.options.openOnClick) o._closeChildPopups(t);else if (e.isEmptyObject(o._openedPopups)) {
      ...
      _closeChildPopups: function _closeChildPopups(t) {
        var n = this,
            o = n._overflowWrapper();
      ...
      _innerPopup: function _innerPopup(e) {
        var t = this._overflowWrapper(),
            n = v(e, t);

        return n[n.length - 1] || e;
      },
      _closeParentPopups: function _closeParentPopups(e) {
        var t = this,
            n = t._overflowWrapper(),
            o = e.data(ke),
            i = n.find(m(o));

        for (o = i.parent().data(ke), t.close(i, !0); o && !t._openedPopups[o] && !i.parent().is(He);) {
          i = n.find(m(o)), t.close(i, !0), o = i.parent().data(ke);
        }
      },
      _click: function _click(n) {
        for (var o, i, r, a, s, l, p = this, c = p.options, u = e(O.eventTarget(n)), d = u[0], f = u[0] ? u[0].nodeName.toUpperCase() : "", m = "INPUT" == f || "SELECT" == f || "BUTTON" == f || "LABEL" == f, v = u.closest(X), g = u.closest(Ee), _ = g[0], k = v.attr("href"), w = u.attr("href"), C = e("<a href='#' />").attr("href"), y = !!k && k !== C, P = y && !!k.match(/^#/), T = !!w && w !== C, x = p._overflowWrapper(); d && d.parentNode != _;) {
          d = d.parentNode;
        }
      ...
      _parentsUntil: function _parentsUntil(n, o, i) {
        var r,
            a,
            s = this._overflowWrapper();
      ...
      _triggerSelect: function _triggerSelect(e, t) {
        var n, o, i, r;
      ...
      _getEventData: function _getEventData(e) {
        var t = {
          sender: this,
          target: e,
          _defaultPrevented: !1,
      ...
      _documentClick: function _documentClick(e) {
        var t = this;
        i((t._overflowWrapper() || t.element)[0], e.target) || (t.clicked = !1);
      },
      _focus: function _focus(n) {
        var o = this,
            i = n.target,
            r = o._hoverItem(),
            a = x();
      ...
      _keydown: function _keydown(e) {
        ...
        if (e.target == e.currentTarget || a == U.ESC) {
          if (s || (s = r._oldHoverItem = r._hoverItem()), o = r._itemBelongsToVertival(s), i = r._itemHasChildren(s), r._keyTriggered = !0, a == U.RIGHT) n = r[l ? "_itemLeft" : "_itemRight"](s, o, i);else if (a == U.LEFT) n = r[l ? "_itemRight" : "_itemLeft"](s, o, i);else if (a == U.DOWN) n = r._itemDown(s, o, i);else if (a == U.UP) n = r._itemUp(s, o, i);else if (a == U.HOME) r._moveHover(s, s.parent().children().first()), e.preventDefault();else if (a == U.END) r._moveHover(s, s.parent().children().last()), e.preventDefault();else if (a == U.ESC) n = r._itemEsc(s, o);else if (a == U.ENTER || a == U.SPACEBAR) n = s.children(".k-link"), n.length > 0 && (r._click({
            target: n[0],
            preventDefault: function preventDefault() {},
            enterKey: !0
          }), i && !s.hasClass(Te) ? (r.open(s), r._moveHover(s, r._childPopupElement(s).children().first())) : r._moveHover(s, r._findRootParent(s)));else if (a == U.TAB) return n = r._findRootParent(s), r._moveHover(s, n), r._checkActiveElement(), t;
          n && n[0] && (e.preventDefault(), e.stopPropagation());
        }
      },
      _hoverItem: function _hoverItem() {
        return this.wrapper.find(".k-item.k-state-hover,.k-item.k-state-focused").filter(":visible");
      },
      _itemBelongsToVertival: function _itemBelongsToVertival(e) {
        var t = this.wrapper.hasClass("k-menu-vertical");
        return e.length ? e.parent().hasClass("k-menu-group") || t : t;
      },
      _itemHasChildren: function _itemHasChildren(e) {
      ...
      _moveHover: function _moveHover(t, n) {
        var o = this,
            i = o._ariaId;
      ...
      _findRootParent: function _findRootParent(e) {
        return this._isRootItem(e) ? e : this._parentsUntil(e, He, "li.k-item").last();
      },
      _isRootItem: function _isRootItem(e) {
        return e.parent().hasClass(J);
      },
      _itemRight: function _itemRight(e, t, n) {
        var o,
            i,
            r,
            a,
      ...
      _itemLeft: function _itemLeft(e, t) {
        var n,
            o,
            i = this;
      ...
      _itemDown: function _itemDown(e, t, n) {
        var o,
            i = this;
        if (t) o = e.nextAll(Re);else {
      ...
      _scrollToItem: function _scrollToItem(e) {
        var t,
            n,
            o,
            i,
      ...
      _itemEsc: function _itemEsc(e, t) {
        var n,
            o = this;
        return t ? (n = e.parent().closest(".k-item"), o.close(n), o._moveHover(e, n), n) : e;
      },
      _childPopupElement: function _childPopupElement(e) {
      ...
      _focusHandler: function _focusHandler(t) {
        var n = this,
      ...
      _animations: function _animations(e) {
      ...
      _dataSource: function _dataSource(e) {
        var t = this,
      ...
      _bindDataSource: function _bindDataSource() {
      ...
      findByUid: function findByUid(e) {
      ...
      _appendItems: function _appendItems(e, t, n) {
        var o = this,
            i = n.find(De).eq(t);
      ...
      _updateItem: function _updateItem(e) {
        var t = this,
            n = t.findByUid(e.uid),
            o = n.next(),
            i = e.parentNode();
      ...
      _accessors: function _accessors() {
        var e,
            t,
            n,
            o = this,
        ...
        for (e in Je) {
          t = i[Je[e]], n = r.attr(O.attr(e + "-field")), !t && n && (t = n), t || (t = e), I(t) || (t = [t]), i[Je[e]] = t;
        }
      },
      _fieldAccessor: function _fieldAccessor(t) {
      ...
      _templates: function _templates() {
        var e = this,
            t = e.options,
            n = B(e._fieldAccessor, e);
        t.template && _typeof(t.template) == Ge ? t.template = R(t.template) : t.template || (t.template = R("# var text = " + n("text") + "(data.item); ## if (typeof data.item.encoded != 'undefined' && data.item.encoded === false) {##= text ## } else { ##: text ## } #")), e.templates = {
      ...
      renderGroup: function renderGroup(e) {
        var t = this,
            n = t.templates || e.menu.templates;
        return n.group(M({
          renderItems: function renderItems(e) {
            for (var t = "", n = 0, o = e.items, i = o ? o.length : 0, r = M({
              length: i
            }, e.group); n < i; n++) {
              t += e.menu.renderItem(M(e, {
                group: r,
                item: M({
                  index: n
                }, o[n])
      ...
      _configurePopupScrolling: function _configurePopupScrolling(e, n) {
        var o = this,
            i = o.popup,
      ...
      _setPopupWidth: function _setPopupWidth(t, n) {
        var o,
            i,
            r,
            a,
      ...
      _showHandler: function _showHandler(t) {
        var n,
            o = t,
            r = this,
            a = r.options,
      ...
      _closeHandler: function _closeHandler(t) {
        var n,
            o = this,
      ...
      _wire: function _wire() {
        var e = this,
            t = e.options,
            n = e.target;
        e._showProxy = B(e._showHandler, e), e._closeProxy = B(e._closeHandler, e), e._closeTimeoutProxy = B(e.close, e), n[0] && (O.support.mobileOS && "contextmenu" == t.showOn ? (e.userEvents = new O.UserEvents(n, {
          filter: t.filter,
          allowSelection: !1
        }), n.on(t.showOn + F + e._marker, !1), e.userEvents.bind("hold", e._showProxy)) : t.filter ? n.on(t.showOn + F + e._marker, t.filter, e._showProxy) : n.on(t.showOn + F + e._marker, e._showProxy));
      },
      _triggerEvent: function _triggerEvent(n) {
        var o = this,
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","telerik/kendo.menu.min.js"], null)
//# sourceMappingURL=/kendo.menu.min.6e56209a.js.map